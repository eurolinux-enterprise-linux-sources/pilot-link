...
find %{buildroot}%{_libdir}/perl5/ -type f -name 'perllocal.pod' -exec rm -f {} \;
...
%files
%defattr(-,root,root,-)
%doc COPYING ChangeLog README NEWS doc/README.usb doc/README.debugging doc/README.libusb README.RHEL
...
%changelog
* Tue Nov 30 2010 C. Sieh <csieh@fnal.gov> - 2:0.12.4-6.0.sl
...
* Mon Dec 21 2009 Ivana Hutarova Varekova <varekova@redhat.com> - 2:0.12.4-5
- Resolves: #548722
  fix source tag

* Thu Dec 03 2009 Dennis Gregorovic <dgregor@redhat.com> - 2:0.12.4-4.1
- Rebuilt for RHEL 6
